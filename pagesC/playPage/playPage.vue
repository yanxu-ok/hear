<template>
  <view class="play_contain">
    <view
      :style="{ background: 'url(' + zhangjieObj.topicImage + ') 0 / cover' }"
      class="play_contain_img_img"
    ></view>

    <u-navbar
      :title="zhangjieObj.topicName"
      :customBack="back"
      background=""
      title-color="#FFFFFF"
    ...
    <template v-if="audiolist">
      <zaudio
        ...
        :stepShow="show"
        themeColor=""
        style="margin-top: 42rpx; padding: 0 25rpx"
        ref="audio"
      ></zaudio>
    </template>
    ...
    <view class="play_button_contain">
      <u-image
        width="32rpx"
        height="36rpx"
        src="https://img11.iqilu.com/29/2020/09/30/575c5d579b43015f2bed559a314c8735.png"
        style="margin-right: 118rpx"
        @tap="handleNext"
      ></u-image>
      <u-image
        width="59rpx"
      ...
      <u-image
        width="32rpx"
        height="35rpx"
        src="https://img11.iqilu.com/29/2020/09/30/39d25a229e4f1f2b82e131a760f03f6c.png"
...
export default {
  ...
  computed: {
    ...
    playimg() {
      // 真的表示暂停 否则 播放
      return this.paused
        ? "https://img11.iqilu.com/29/2020/09/30/c917c5fef687d3d1f5b5d6fe51be2b5e.png"
