	...
	<view class="list_page_content">
		...
		<u-navbar :title="title" background="" title-color="#333333" back-icon-color="#333333">
			<view slot="right" @tap="handlePaixu">
				<image src="https://img11.iqilu.com/29/2020/09/30/122d098e8503acbe3b6f7d0e764197c2.png" style="width: 30rpx;height: 30rpx;padding-right: 20rpx;" v-if="leixing !== 'lishi'  "></image>
				<view v-else></view>
			</view>
		</u-navbar>

		<view style="height: 150rpx;" v-if="leixing === 'lishi' ">
			<u-search placeholder="" @handleIcon="custom" v-model="content" class="search_c" margin="35rpx auto 0 auto" @search="custom"></u-search>
		</view>
		...
		methods: {
			...
			handlePlay(item) {
				...
				if (this.title == BoDan) {
					...
					let url = item.radioType == 1 ? '/pagesC/playPage/playPage?topicId=' + item.topicId + '&authorId=' + item.userId +
