	...
	<view class="search_flex">
		...
		<scroll-view style="height: 1200rpx;" scroll-y>
			...
			<view class="search-btn" @tap="doSearch(false)">搜索</view> -->
					<search @handleIcon="doSearch" :show-action="true" height="68"  v-model="keyword" @search="doSearch" :clearabled="true" :animation="true"></search>
				</view>
				...
				<scroll-view class="keyword-box" v-if="!isShowKeywordList" scroll-y>
					...
					<view class="keyword-block" v-if="oldKeywordList.length>0">
						<view class="keyword-list-header">
							<view>历史搜索</view>
							<view>
								<u-image @click="oldDelete" width="37rpx" height="39rpx" src="https://img11.iqilu.com/29/2020/09/30/2f4eef461bb5e7d2a94333472a4173c2.png"></u-image>
							</view>
						</view>
						<view class="keyword">
