	...
	<view class="myhome">
		...
		<view style="display: flex;flex-wrap: wrap;justify-content: space-between;margin-top: 35rpx;">
			<template v-for="(item,index) in bodanList">
				<block :key="index">
					<shudan titleWidth="193rpx" left="0" :type="priv == 1 ? 'bodan' : 'zhuanti' " :item="item" :image="item.topicImage"
		...
		<view style="display: flex;justify-content: space-between;">
			...
			<view @tap="handleQuanbu1(shudanIndex)">全部></view>
		</view>
		...
		<view style="display: flex;flex-wrap: wrap;justify-content: space-between;margin-top: 35rpx;">
			<template v-for="(item,index) in zhuantiList">
				<block :key="index">
					<shudan titleWidth="193rpx" :type="type" left="0" :item="item" :image="item.topicImage" :title="item.topicName"
