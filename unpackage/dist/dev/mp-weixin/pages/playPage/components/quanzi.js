...
/* harmony import */ var _quanzi_vue_vue_type_template_id_3aa00ae6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./quanzi.vue?vue&type=template&id=3aa00ae6& */ 349);
/* harmony import */ var _quanzi_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./quanzi.vue?vue&type=script&lang=js& */ 351);
...
/* harmony import */ var _quanzi_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./quanzi.vue?vue&type=style&index=0&lang=scss& */ 357);
...

{
  ...
  (0, _vuex.mapState)({
    ...
    dianzan: function dianzan() {
      ...
      if (this.zhangjieList[this.currectPlayIndex]) {
        var result = this.zhangjieList[this.currectPlayIndex].isPraise ? __webpack_require__(/*! @/static/listen/yidianzan.png */ 355) :
        __webpack_require__(/*! @/static/images/dianzan.png */ 356);
        return result;
      }
    } }),
  ...
  (0, _vuex.mapActions)(['insert_praise_add', 'delete_praise_cancel', 'insert_collect_chapter', 'delete_collect_chapter'])), {}, {
    ...
    // 是否点赞
    handleParse: function handleParse() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var currectPlay, result, newList, _result, _newList;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                currectPlay = _this.zhangjieList[_this.currectPlayIndex];if (!
                currectPlay.isPraise) {_context.next = 8;break;}_context.next = 4;return (
                  _this.delete_praise_cancel({
                    userId: 1,
                    audioId: currectPlay.chapterId,
                    praiseType: 1 }));case 4:result = _context.sent;
                ...
                //需要关注调用接口
                console.log(currectPlay, '当前播放的章节');_context.next = 11;return (
                  _this.insert_praise_add({
                    userId: 1,
                    audioId: currectPlay.chapterId,
                    praiseType: 1 }));case 11:_result = _context.sent;
    ...
    // 是否收藏
    handleShoucang: function handleShoucang() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var currectPlay, result, newList;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                currectPlay = _this2.zhangjieList[_this2.currectPlayIndex];if (!
                currectPlay.isChapterCollect) {_context2.next = 8;break;}_context2.next = 4;return (
                  _this2.delete_collect_chapter({
                    collectChapterId: currectPlay.collectChapterId }));case 4:result = _context2.sent;
                ...
                }_context2.next = 10;break;case 8:
                //需要收藏调用接口
                console.log(currectPlay, '当前播放的章节');
                uni.navigateTo({
                  url: '/pages/shudan/shudan?userId=1&type=zj&chapterId=' + currectPlay.chapterId });case 10:case "end":return _context2.stop();}}}, _callee2);}))();
