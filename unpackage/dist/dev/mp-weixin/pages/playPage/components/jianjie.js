...
/* harmony import */ var _jianjie_vue_vue_type_template_id_4831c524___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jianjie.vue?vue&type=template&id=4831c524& */ 811);
/* harmony import */ var _jianjie_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jianjie.vue?vue&type=script&lang=js& */ 813);
...
/* harmony import */ var _jianjie_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./jianjie.vue?vue&type=style&index=0&lang=scss& */ 815);
...
var render = function() {
  ...
  var f0 = _vm._f("titleFilter")(_vm.zhangjieObj.nickName, 5)

  var f1 = _vm._f("titleFilter")(_vm.zhangjieObj.userDescribe, 8)
...

{
  ...
  (0, _vuex.mapActions)(['insert_focus', 'delete_focus'])), {}, {
    // 关注作者
    handleGuanzhu: function handleGuanzhu() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var isLog, result, newObj, _result, _newObj;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:

                isLog = (0, _index.isLogin)(); // 判断用户是否登录
                if (isLog) {_context.next = 4;break;}
                uni.navigateTo({
                  url: '/pages/login/login' });return _context.abrupt("return");case 4:if (!




                _this.zhangjieObj.isFocus) {_context.next = 11;break;}_context.next = 7;return (

                  _this.delete_focus(_this.zhangjieObj.fansId));case 7:result = _context.sent;
                if (result.success) {
                  ...
                  _this.insert_focus(_this.zhangjieObj.userAuthorId));case 13:_result = _context.sent;
                if (_result.success) {
